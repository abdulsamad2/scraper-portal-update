...
const DEFAULT_FLAGS: FeatureFlags = {
  ...
  eventEdit: 'enabled', eventExclusions: 'enabled', autoDelete: 'enabled', proxies: 'enabled',
};
...
const FLAG_GROUPS: FlagGroup[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      { key: 'proxies', label: 'Proxies', description: 'Proxy management (CRUD over the shared Mongo proxies collection)' },
    ],
  },
];
