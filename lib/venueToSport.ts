export type EventType = 'NFL' | 'MLB' | 'NHL' | 'NBA' | 'WNBA' | 'MLS' | 'College Football' | 'Tennis' | 'WWE' | 'Monster Jam' | 'Disney' | 'Other';

export const EVENT_TYPES: EventType[] = ['NFL', 'MLB', 'NHL', 'NBA', 'WNBA', 'MLS', 'College Football', 'Tennis', 'WWE', 'Monster Jam', 'Disney', 'Other'];
